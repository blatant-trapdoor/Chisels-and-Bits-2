...
public class SelectedBlockItemMode implements IItemMode {
    ...
    private SelectedBlockItemMode(final ResourceLocation key) { this.key = key; }
    ...
    public ItemStack getStack() {
        return new ItemStack(ForgeRegistries.BLOCKS.getValue(key));
    }
    ...
    public ItemModeType getType() { return ItemModeType.SELECTED_BLOCK; }
}
