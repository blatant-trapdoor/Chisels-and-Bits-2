...
public class SimpleGeneratedModel implements IBakedModel
{
			...
			final TextureAtlasSprite texture )
	{
		...
		for ( final Direction side : Direction.values() )
		{
			...
			final BakedQuad g = faceBakery.makeBakedQuad( toB, fromB, bpf, texture, side, mr, bpr, false ); //TODO removed a true here, that might have broken something
			...
			final VertexFormat format )
	{
		...
		final Builder b = new Builder( format );
